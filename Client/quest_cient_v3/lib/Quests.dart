...
class Quest{
  ...
  //Лишняя часть, + не работает из-за того, что я не прописал  toJson для Book
  /*
...
class Buttons {
  ...
  Buttons.fromJson(Map<String, dynamic> json) {
    button1 =
        json['button1'] != null ? new OneButton.fromJson(json['button1']) : null;
    button2 =
        json['button2'] != null ? new OneButton.fromJson(json['button2']) : null;
  }
